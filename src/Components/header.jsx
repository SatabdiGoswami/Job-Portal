...
const Header = () => (
  <header className="bg-blue-950 text-white py-2 px-4 shadow-md border-b-2 border-blue-300">
    <nav className="container mx-auto flex items-center gap-6 font-semibold text-xl">
      ...
      <div className="flex gap-4">
        ...
        <Link to="/list-candidate" className="hover:text-yellow-300 p-4 border-blue-100">List Candidate</Link>
